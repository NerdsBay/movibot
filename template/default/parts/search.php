        ...
        <div class="movie-browse-agile">
            <div class="browse-agile-w3ls general-w3ls">
                <div class="tittle-head">
                    <div class="container">
                        <h4 class="latest-text">Searching for "<?php echo $search; ?>"</h4>
                ...
                <div class="container">
					...
					<?php 
						if(!empty($movies)){
							...
							echo "<h1>No more movies found!</h1>";
						}
					?>
                        <div class="clearfix"></div>
                    </div>
                ...
                <ul>
					<?php
						if(!empty($movies)){
							if(!empty($page)){
								if($page == 2 && $page !== 1){
									echo '<li><a class="last" href="'.site_url.'/search/'.$search.'">Prev</a></li>';
								} else {
									$ppage = $page - 1;
									echo '<li><a class="last" href="'.site_url.'/search/'.$search.'/'.$ppage.'">Prev</a></li>';
								}
							}
							if(empty($page)){
								$npage = 2;
								echo '<li><a class="last" href="'.site_url.'/search/'.$search.'/'.$npage.'">Next</a></li>';
							} else {
								if($page <= 1){
									$npage = 2;
								} else {
