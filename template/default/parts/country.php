        ...
        <div class="movie-browse-agile">
            <div class="browse-agile-w3ls general-w3ls">
                <div class="tittle-head">
                    <div class="container">
                        <h4 class="latest-text"><?php echo ucfirst($sys->clean_title($country)); ?></h4>
                        <div class="agileits-single-top">
                            <ol class="breadcrumb">
                                <li><a href="<?php echo site_url; ?>">Home</a></li>
                                <li class="active"><?php echo ucfirst($sys->clean_title($country)); ?></li>
                            </ol>
                        </div>
                    </div>
                </div>
                <div class="container">
					...
					<?php 
						if(!empty($movies)){
							...
							echo "<h1>No more movies found for this country!</h1>";
						}
					?>
                        <div class="clearfix"></div>
                    </div>
                ...
                <ul>
					<?php
						if(!empty($movies)){
							if(!empty($page)){
								if($page == 2 && $page !== 1){
									echo '<li><a class="last" href="'.site_url.'/country/'.$country.'">Prev</a></li>';
								} else {
									$ppage = $page - 1;
									echo '<li><a class="last" href="'.site_url.'/country/'.$country.'/'.$ppage.'">Prev</a></li>';
								}
							}
							if(empty($page)){
								$npage = 2;
								echo '<li><a class="last" href="'.site_url.'/country/'.$country.'/'.$npage.'">Next</a></li>';
							} else {
								if($page <= 1){
									$npage = 2;
								} else {
